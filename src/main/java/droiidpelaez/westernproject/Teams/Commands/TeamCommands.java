        ...
        if (sender instanceof Player) {
            ...
            // ===== REMOVE =====
                ...
                if (args.length == 1) {
                    ...
                    if (target == null) {
                        p.sendMessage(ChatColor.GRAY + "This player is not " +
                ...
                //This handles offline players, or misspelled players
                if (target == null) {
                    p.sendMessage(ChatColor.GRAY + "This player is not" + ChatColor.DARK_AQUA + " online.");
                    return true;
                }
            ...
            if (args[0].toLowerCase().compareTo("list") == 0) {
                // ===== ERROR CHECKING =====
                if (args.length != 1) {
                    p.sendMessage(ChatColor.GRAY + "Incorrect usage, please try: " + ChatColor.DARK_AQUA + "/team create {team name}");
                    return true;
